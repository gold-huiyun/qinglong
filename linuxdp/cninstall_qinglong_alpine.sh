...
QL_URL="${QL_URL:-https://gitee.com/${QL_MAINTAINER}/qinglong.git}"
...
# Git 全局配置
# --------------------------
git config --global user.email "qinglong@users.noreply.gitee.com"
...
echo "[5/6] 拉取静态资源..."
git clone --depth=1 -b "${QL_BRANCH}" https://gitee.com/${QL_MAINTAINER}/qinglong-static.git /static
